...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        buttonLight = new JButton("Light", new FlatSVGIcon("zentech/menu/mode/light.svg"));
        buttonDark = new JButton("Dark", new FlatSVGIcon("zentech/menu/mode/dark.svg"));
