...
public class FormHomePage extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bảo mật");

        jLabel3.setText("Chưa có hình");

        jLabel4.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel4.setText("Tối ưu");

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel5.setText("Hiệu quả");

        jLabel6.setText("Chưa có hình");

        jLabel7.setText("Chưa có hình");
        ...
        jLabel2.setText("Dùng công nghệ để tiến xa hơn");

        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel9.setText("-Zentech");
